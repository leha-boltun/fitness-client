...
export const WorkoutControllerApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getTotalTimeUsingGET(id: number, options: any = {}): FetchArgs {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling getTotalTimeUsingGET.');
            }
            const localVarPath = `/pi/workout/{id}/total_time`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
...
export const WorkoutControllerApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getTotalTimeUsingGET(id: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<string> {
            const localVarFetchArgs = WorkoutControllerApiFetchParamCreator(configuration).getTotalTimeUsingGET(id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const WorkoutControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        getTotalTimeUsingGET(id: number, options?: any) {
            return WorkoutControllerApiFp(configuration).getTotalTimeUsingGET(id, options)(fetch, basePath);
        },
        /**
         * 
         * @summary processNextEventSetWeight
...
export class WorkoutControllerApi extends BaseAPI {
     ...
     * @memberof WorkoutControllerApi
     */
    public getTotalTimeUsingGET(id: number, options?: any) {
        return WorkoutControllerApiFp(this.configuration).getTotalTimeUsingGET(id, options)(this.fetch, this.basePath);
    }
...
export const WsetControllerApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        editWsetUsingPUT(data: DWset, options: any = {}): FetchArgs {
            // verify required parameter 'data' is not null or undefined
            if (data === null || data === undefined) {
                throw new RequiredError('data','Required parameter data was null or undefined when calling editWsetUsingPUT.');
            }
            const localVarPath = `/pi/wset/edit`;
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'PUT' }, options);
            const localVarHeaderParameter = {} as any;
            const localVarQueryParameter = {} as any;
...
export const WsetControllerApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        editWsetUsingPUT(data: DWset, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = WsetControllerApiFetchParamCreator(configuration).editWsetUsingPUT(data, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response;
...
export const WsetControllerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        editWsetUsingPUT(data: DWset, options?: any) {
            return WsetControllerApiFp(configuration).editWsetUsingPUT(data, options)(fetch, basePath);
        },
    };
};
...
export class WsetControllerApi extends BaseAPI {
     ...
     * @memberof WsetControllerApi
     */
    public editWsetUsingPUT(data: DWset, options?: any) {
        return WsetControllerApiFp(this.configuration).editWsetUsingPUT(data, options)(this.fetch, this.basePath);
    }
